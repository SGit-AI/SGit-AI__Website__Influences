...
this site generates twenty-five entry pages from data. So it is walked from the tree
instead: every .html file that is not under .git or .github, ordered with the front page
first and the rest alphabetically, with lastmod taken from the release date in
admin/versions.html.
"""
import re
import sys
...
from pagelib import ROOT, HOST                                  # noqa: E402
